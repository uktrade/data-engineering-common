...
import data_engineering.common.sso as sso
...
@pytest.fixture(scope="function")
def mock_oauth():
    with unittest.mock.patch("data_engineering.common.sso.OAuth") as mock_oauth:
        yield mock_oauth().register()


@pytest.fixture(scope="module")
def mock_url_for():
    with unittest.mock.patch("data_engineering.common.sso.url_for") as mock_url_for:
        yield mock_url_for
